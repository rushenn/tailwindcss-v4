...
name: tailwindcss-v4
description: >
  Enforce correct Tailwind CSS v4 usage in all projects — especially Next.js. Use this skill
  whenever you write, review, or modify any component, page, or stylesheet that uses Tailwind CSS
  utility classes. This includes new files, editing existing code, code reviews, and migrations from
  v3. Always trigger this skill when you see className="...", class="...", @apply, @utility,
  dark mode, cn(), twMerge, or any Tailwind utility pattern in the codebase. Never use Tailwind v3
  patterns, never use unnecessary arbitrary values when canonical classes exist, and always reference
  the official v4 docs for unfamiliar utilities.
---
